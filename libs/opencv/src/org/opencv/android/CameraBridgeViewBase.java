    ...
    protected void deliverAndDrawFrame(CvCameraViewFrame frame) {
        ...
        if (bmpValid && mCacheBitmap != null) {
            ...
            if (canvas != null) {
                ...
                /** 此處為原Lib code 因為Camera View 為 LandScape 而修改 **/
...
//                    mtx.preTranslate((canvas.getWidth() - mCacheBitmap.getWidth())/2, (canvas.getHeight() - mCacheBitmap.getHeight())/2);
//                    mtx.postRotate(90, canvas.getWidth() / 2, canvas.getHeight() / 2);
//                    mtx.postScale(scale, scale, canvas.getWidth() / 2, canvas.getHeight() / 2);
////
//                    Log.v("Raymomnd ", " Bridage_rotateMe :" + String.valueOf(down_times++));
//
//                    canvas.drawBitmap(mCacheBitmap, mtx , null);
//
//
//
//
